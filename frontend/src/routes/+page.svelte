...
<main class="flex h-screen flex-col items-center justify-center">
    ...
    <div class="flex max-w-5xl justify-center gap-4 px-3">
        <NextStep
            ...
            <p>
                Edit <code class="text-lime-300 break-all">src/routes/+page.svelte</code> to see your
                changes live.
            </p>
            <p>
                The source for these cards is in <code class="text-lime-300 break-all">
                >src/lib/components/NextStep.svelte</code>.
            </p>
            <p>
                There's some global styling in <code class="text-lime-300 break-all">src/app.css</code>.
            </p>
        </NextStep>
    </div>
</main>
